...
func SetDeletedFlag(notificationService NotificationService) func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		err = notificationService.SetDeletedFlag(c.Request.Context(), userID, req.NotificationIDs)
		if err != nil {
